  ...
  return (
    <div className="space-y-8 pb-12">
      <div className="flex justify-between items-end">
        ...
        <button className="px-6 py-3 bg-slate-900 text-white rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-slate-800 transition-all shadow-xl shadow-slate-200 flex items-center space-x-2">
          ...
          <div className="bg-white rounded-[3rem] border border-slate-200 shadow-xl shadow-slate-200/50 flex flex-col">
            <div className="p-8 border-b border-slate-100 flex justify-between items-center">
              ...
              <div className="flex bg-slate-50 p-1 rounded-xl">
                <button className="px-4 py-1.5 bg-white shadow-sm rounded-lg text-xs font-black text-emerald-600 uppercase tracking-tighter">List</button>
                <button className="px-4 py-1.5 text-xs font-black text-slate-400 uppercase tracking-tighter">Time</button>
              </div>
            </div>
